...
import { farms } from "../../domain/factories/farms";
  ...
  return (
    <section className={"body__container"}>
      <div className="title__container">
        <h1>More then 40 Luxury Farms</h1>
      </div>
      {farms.map((prop, index) => {
        switch (pagination) {
          case 0:
            return index <= 2 ? (
              <>
                <div
                  className="farm__container"
                  key={index}
                  style={
                    index == 2
                      ? { borderStyle: "none" }
                ...
                >
                  <div className="img__container">
                    ...
                    <div className="btn from-center">Show Farm</div>
                  </div>
                  <div className="farm-prop__container">
                    <h5>
