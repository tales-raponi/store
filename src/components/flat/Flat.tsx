...
import { flats } from "../../domain/factories/flats";
  ...
  return (
    <section className={"body__container"}>
      <div className="title__container">
        <h1>More then 40 Luxury Flats</h1>
      </div>
      {flats.map((prop, index) => {
        switch (pagination) {
          case 0:
            return index <= 2 ? (
              <>
                <div
                  className="flat__container"
                  key={index}
                  style={
                    index == 2
                      ? { borderStyle: "none" }
                ...
                >
                  <div className="img__container">
                    ...
                    <div className="btn from-center">Show Flat</div>
                  </div>
                  <div className="flat-prop__container">
                    <h5>
